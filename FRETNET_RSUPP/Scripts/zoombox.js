...
zoombox = {
	...
	getContent : function(url){
			...
			if(zoombox.filtreImg.test(url)){
				...
				content='<object type="application/x-shockwave-flash" data="'+zoombox.FLVPlayer+'><embed src="'+zoombox.FLVPlayer+'" width="'+zoombox.width+'" height="'+zoombox.height+'" controller="true" cache="true" autoplay="true"/>';
			}
