<%@ Page Language="C#" Title="Inscrire une connexion externe" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="FRETNET_RSUPP.Account.RegisterExternalLogin" %>
